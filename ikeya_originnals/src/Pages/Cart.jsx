  ...
  return (
    <Layout>
      <div className="pt-32 pb-20 px-6 max-w-7xl mx-auto">
        <h1 className="text-4xl font-display text-black mb-12 uppercase tracking-tighter">
          Your Bag
        </h1>
        ...
        {cart && cart.length > 0 ? (
          ...
          <div className="py-20 text-center space-y-6">
            ...
            <Link
              to="/shop"
              className="inline-block bg-black text-white px-12 py-4 text-[10px] uppercase font-bold tracking-widest hover:bg-amber-900 transition-all"
            >
              Shop Collection
            </Link>
          </div>
