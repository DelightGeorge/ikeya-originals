        ...
        <section className="px-6 max-w-7xl mx-auto mb-32">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div className="order-2 lg:order-1">
              <span className="text-amber-800 uppercase tracking-[0.4em] text-[10px] font-bold block mb-4">
                Our Heritage
              </span>
            ...
            <div className="relative order-1 lg:order-2">
              ...
              <div className="absolute -bottom-8 -left-8 bg-black text-white p-10 hidden md:block shadow-2xl">
                ...
                <p className="text-[10px] uppercase tracking-[0.3em] text-amber-600 font-bold mt-2">
                  Lagos, Nigeria
                </p>
              </div>
            </div>
        ...
        <section className="bg-black py-32 px-6">
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-20">
            <div className="flex gap-8 items-start border-l border-amber-800/30 pl-8">
              ...
              <div>
                <h2 className="text-2xl font-display text-white mb-6 uppercase tracking-widest font-bold">
                  The Mission
                </h2>
            ...
            <div className="flex gap-8 items-start border-l border-amber-800/30 pl-8">
              ...
              <div>
                ...
                <p className="text-neutral-400 leading-relaxed text-lg font-light">
                  To become Nigeria's leading lifestyle brand where creativity,
                  beauty-driven innovation, and African heritage converge for
                  the future-focused individual.
                </p>
              </div>
            </div>
          </div>
            ...
            {[
              ...
              <div key={i} className="group space-y-6">
                ...
                <div className="space-y-3">
                  <h4 className="font-bold text-black uppercase text-[11px] tracking-[0.3em]">
                    {v.title}
                  </h4>
