      ...
      <div className="pt-32 pb-20 px-6 max-w-7xl mx-auto">
        ...
        <header className="mb-12 text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-display text-black mb-4 uppercase tracking-tighter font-bold">
            The{" "}
            <span className="text-amber-800 italic font-light">Collection</span>
          </h1>
          ...
          <div className="flex gap-8">
            {categories.map((cat) => (
              <button
                ...
                className={`text-xs uppercase tracking-[0.2em] font-bold transition-all pb-1 ${
              ...
              return (
                <div key={p.id} className="group flex flex-col h-full">
                  ...
                  <div className="mt-auto space-y-1 text-center md:text-left">
                    ...
                    <p className="text-[10px] uppercase text-black/40 tracking-widest">
                      {p.type}
                    </p>
